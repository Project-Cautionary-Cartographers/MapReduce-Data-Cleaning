...
public class analyzeVicRace {

  public static class vRaceMapper
    ...
    public void map(LongWritable key, Text value, Context context
        ...
        if (holder.length == 21) {
          try {
            ...
            else if (location.equals("AMERICAN INDIAN/ALASKAN NATIVE")) {
              String s6 = "AMERICAN INDIAN/ALASKAN NATIVE";
              context.write(new Text(s6), onee);
            }
  ...
  public static class vRaceReducer
  ...
  public static void main(String[] args) throws Exception {
    ...
    Job job = Job.getInstance(conf, "analyzeVicRace");
    job.setJarByClass(analyzeVicRace.class);
    job.setNumReduceTasks(1);

    job.setMapperClass(vRaceMapper.class);
    //job.setCombinerClass(boroReducer.class);
    job.setReducerClass(vRaceReducer.class);
