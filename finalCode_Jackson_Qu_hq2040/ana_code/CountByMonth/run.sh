...
# Package
jar cf CountByMonth.jar *.class

# Clean class files
rm *.class

# Run
hadoop jar CountByMonth.jar CountByMonth -libjars ../lib/opencsv-5.7.1.jar final/data/Clean_data.csv final/output/CountByMonth
