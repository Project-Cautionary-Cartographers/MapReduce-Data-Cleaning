...
# Package
jar cf CountADDRPCTCD.jar *.class

# Clean class files
rm *.class

# Run
hadoop jar CountADDRPCTCD.jar CountADDRPCTCD -libjars ../lib/opencsv-5.7.1.jar final/data/Clean_data.csv final/output/CountADDRPCTCD
